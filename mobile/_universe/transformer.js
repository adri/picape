...
const { compactMapping } = require("react-native/node_modules/metro-bundler/src/Bundler/source-map");
...
const EXPO_REACT_NATIVE_PATH = path.join(process.env.EXPO_UNIVERSE_DIR, "react-native-lab", "react-native");
